...
public class TeamMentorMessage {
    ...
    public TeamMentorMessage(Integer t_id, Integer p_id, Integer m_id, Integer tp_dict, Integer tp_pass, String tp_info, Integer tp_join, Integer sm_dict, Integer sm_pass, String sm_info, Integer sm_join, Integer st_id) {
        this.t_id = t_id;
        this.p_id = p_id;
        this.m_id = m_id;
