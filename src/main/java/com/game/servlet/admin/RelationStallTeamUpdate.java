...
@WebServlet(value = "/admin/RelationStallTeamUpdate")
public class RelationStallTeamUpdate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Result<String> result = relation.updateStallTeamRelation(stallTeamMessage);
